...
//BookContext i olusturmus oluyoruz
//iletmek istediğimiz veri için bi yol olmus olacak
export const BookContext = React.createContext(
  //varsayılan baslangıc degerimizi buraya yazıyoruz. bu array,obje,degisken olabilir
)
...
//  1. yöntem: Default Value --> this.context
// - Context nesnesini olusturduk
// - Baslangıc degeri verdik ve export ettik
// - ilgili componente import ettik
// - contextType yardımıyla contexti ilgili componente atadık
// - this.context yardımıyla ilgili veriye ulastık
...
// - Veriyi gondereceğimiz componente Context import ediyoruz
